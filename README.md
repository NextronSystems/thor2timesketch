...
- **THOR JSON v1.0.0** (generated by THOR 10.7 and earlier by default)
- **THOR JSON v2.0.0** (can be generated by THOR 10.7 on request `--jsonv2`)  
- **Audit-trail** logs (very verbose log; new in v10.7; generate with `--audit-trail`)
